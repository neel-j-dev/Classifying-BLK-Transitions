...
def main():
    parser = argparse.ArgumentParser(description="Train/evaluate a GNN on the test split.")
    parser.add_argument("--split", type=Path, default=Path("../blt_dataset/test.npz"))
    ...
    print(f"[test] accuracy={stats['accuracy']:.3f} f1={stats['f1']:.3f} "
